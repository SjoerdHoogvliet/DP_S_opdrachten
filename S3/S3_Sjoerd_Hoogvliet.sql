...
-- u.cursus kan ook c.code zijn
SELECT u.cursus, u.begindatum, c.lengte, m.naam
FROM uitvoeringen u
JOIN medewerkers m ON c.docent = m.mnr
...
SELECT afdeling.naam AS "afdeling", hoofd.naam AS "hoofd"
FROM afdelingen afdeling
JOIN medewerkers hoofd ON afdeling.hoofd = hoofd.mnr
