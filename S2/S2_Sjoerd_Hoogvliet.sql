...
VALUES('S02', CAST('2025-03-02' AS DATE), 7369, 'LEERDAM');
...
-- voer zijn of haar gegevens in. Kies een personeelnummer boven de 8000.
                                                                                        -- [TEST]
-- Aangezien een stagiair waarschijnlijk wel een chef heeft heb ik gekozen daar nu de directeur in te vullen
INSERT INTO medewerkers(mnr, naam, voorl, functie, chef, gbdatum, maandsal, comm, afd)
VALUES(8001, 'PLOEMACHER', 'M', 'STAGIAIR', 7839, CAST('1999-04-23' AS DATE), 1000, null, 20)
...
-- Ik zie dat alle cursussen een type hebben, daarom kies ik ook maar een type voor deze cursus ondanks dat deze ongespecificeerd is
INSERT INTO cursussen(code, omschrijving, type, lengte)
VALUES('D&P', 'Data & Persistency', 'ALG', 6);

-- JM Jansen leek mij wel een geschikte docent voor deze cursus ;)
INSERT INTO uitvoeringen(cursus, begindatum, docent, locatie)
VALUES('D&P', CAST('2025-03-02' AS DATE), 7566, 'LEERDAM');

INSERT INTO uitvoeringen(cursus, begindatum, docent, locatie)
VALUES('D&P', CAST('2025-03-09' AS DATE), 7566, 'LEERDAM');

INSERT INTO inschrijvingen(cursist, cursus, begindatum, evaluatie)
VALUES(8001, 'D&P', CAST('2025-03-02' AS DATE), null);

INSERT INTO inschrijvingen(cursist, cursus, begindatum, evaluatie)
VALUES(7782, 'D&P', CAST('2025-03-09' AS DATE), null);

INSERT INTO inschrijvingen(cursist, cursus, begindatum, evaluatie)
VALUES(7902, 'D&P', CAST('2025-03-09' AS DATE), null);
...
UPDATE medewerkers SET maandsal = maandsal * 1.05 WHERE (afd = 30 AND NOT functie = 'MANAGER');
...
DELETE FROM medewerkerse WHERE naam = 'ALDERS';

-- Alders heeft nog een inschrijving staan, aangezien dit aan elkaar gekoppeld is (inschrijvingen.cursist = medewerkers.mnr) mag hij niet verwijderd worden, zie de volgende error die de SQL geeft:
...
INSERT INTO medewerkers(mnr, naam, voorl, functie, chef, gbdatum, maandsal, comm, afd)
VALUES(8002, 'HOOGVLIET', 'SJ', 'MANAGER', 7839, CAST('2004-07-09' AS DATE), 7000, null, 50);
