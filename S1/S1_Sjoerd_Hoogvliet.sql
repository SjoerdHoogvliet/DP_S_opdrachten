...
-- Wanneer ik de onderstaande update uitvoer krijg ik deze foutmelding:
-- ERROR:  Failing row contains (7369, SMIT, N, TRAINER, 7902, 1985-12-17, 800.00, null, 20, G).new row for relation "medewerkers" violates check constraint "m_geslacht_chk" 

-- ERROR:  new row for relation "medewerkers" violates check constraint "m_geslacht_chk"
-- SQL state: 23514
-- Detail: Failing row contains (7369, SMIT, N, TRAINER, 7902, 1985-12-17, 800.00, null, 20, G).
...
VALUES(8000, 'DONK', 'A', 'MANAGER', 7839, CAST('2004-07-09' AS date), 7000, 50, 'M');
...
INSERT INTO afdelingen(anr,naam,locatie)
VALUES (nextval('anr_seq'),'NIEUW', 'ZWIJNDRECHT')

INSERT INTO afdelingen(anr,naam,locatie)
VALUES (nextval('anr_seq'),'OOK NIEUW', 'UTRECHT')

INSERT INTO afdelingen(anr,naam,locatie)
VALUES (nextval('anr_seq'),'VOLGENDE', 'HENDRIK-IDO-AMBACHT')

INSERT INTO afdelingen(anr,naam,locatie)
VALUES (nextval('anr_seq'),'NOG EEN', 'GORINCHEM')

-- Wanneer ik probeer:
INSERT INTO afdelingen(anr,naam,locatie)
VALUES (nextval('anr_seq'),'LAATSTE', 'BARENDRECHT')
-- Krijg ik de volgende foutmelding:
-- ERROR:  A field with precision 2, scale 0 must round to an absolute value less than 10^2.numeric field overflow 
...
VALUES('1234AB', '5', CAST('2025-01-06' AS DATE), CAST('2030-01-06' AS DATE), 0612345678, 8000);
...
ALTER TABLE medewerkers
ADD CONSTRAINT verkoper_heeft_comm 
